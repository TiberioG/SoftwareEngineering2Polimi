...
[R3] & Date, time and position should be automatically added to the violation reported  & Take Picture, Get Picture \\ \hline  %%date time loc autoadded
[R4] & We should require the user to send again a picture in case the plate is not visible & Take Picture, Get Picture \\ \hline %%plate not visible
...
[R6] & Application must automatically determine the street name where User is & Take Picture, Get Picture \\ \hline  %%streetname
...
[R12] & Regular users cannot mine data about plates of the offenders & List vehicles, CoreUtils \\ \hline %% endus no
[R13] & Authority users can know the exact licence plate when mining data about offenders & List vehicles, CoreUtils \\ \hline %%authority see plate
