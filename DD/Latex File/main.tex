...
%------------------------------------------------------------------------------------------------------------------------------------------------
\clearpage
{\color{polidark}{\section{Architectural Design}}}
\label{sect:architectural}
\input{Files/architectural}

%------------------------------------------------------------------------------------------------------------------------------------------------
\clearpage
{\color{polidark}{\section{User Interface Design}}}
\label{sect:ui}
\input{Files/ui}

%------------------------------------------------------------------------------------------------------------------------------------------------
\clearpage
{\color{polidark}{\section{Requirements Traceability}}}
\label{sect:requirements}
\input{Files/requirements}

%------------------------------------------------------------------------------------------------------------------------------------------------
\clearpage
{\color{polidark}{\section{Implementation, Integration and Test Plan}}}
\label{sect:iit}
\input{Files/implemintest}
